...
public class LifeRecordController {
    ...
    public  Response selectAllLifeRecord(){
    ...
    public Response updateLifeRecordByID(LifeRecord lifeRecord){
    ...
    public Response addLifeRecord(LifeRecord lifeRecord){
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");//设置日期格式
    ...
    public Response deleteLifeRecordByID(LifeRecord lifeRecord){
        Response response=new Response();
